...
async function loadContent() {
    try {
        ...
        const topBar = await fetch('components/topbar.html').then(res => res.text());
        const sidebar = await fetch('components/sidebar.html').then(res => res.text());
        const mainContent = await fetch('components/maincontent.html').then(res => res.text());
        const aboutSystem = await fetch('components/aboutsystem.html').then(res => res.text());
        const aboutUs = await fetch('components/aboutus.html').then(res => res.text());        
